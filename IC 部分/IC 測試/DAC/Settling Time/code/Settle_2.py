...
def plot_csv(data):
    ...
    plt.xlabel('Time (μs)')
    plt.ylabel('Voltage (V)')
    plt.title('Channel 3: VOUT, 2.05 V')
    plt.text( 252.5, 1, 'Settling Time = 2.41 μs', color='violet', ha='center', va='center', fontsize=12)
    plt.grid(False)
    ...
    plt.suptitle('DAC 6, scope_12.png, scope_13.csv', x=0.53)

    # Display the plot
    plt.show()

# Specify the path to your CSV file
csv_file_path = 'scope_13.csv'
